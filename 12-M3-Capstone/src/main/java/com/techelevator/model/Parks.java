...
public class Parks {
	...
	public double milesOfTrail;
	public int numberOfCampsites;
	public String climate;
	public int yearFounded;
	public int annualVisitorCount;
	public String inspirationalQuote;
	public String inspirationalQuoteSource;
	public String parkDescription;
	public int entryFee;
	public int numberOfAnimalSpecies;
